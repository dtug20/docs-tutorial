        ...
        <>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    ...
                    />
                    <DialogFooter>
                        <Button onClick={handleImageUrlSubmit} className="bg-black text-white hover:bg-black/80">Insert</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </>
...
const LinkButton = () => {
    ...
    return (
        <DropdownMenu onOpenChange={(open) => {
            ...
            <DropdownMenuContent className="p-2.5 flex items-center gap-x-2 bg-white">
                <Input
                    placeholder="https://example.com"
                    value={value}
                    onChange={(e) => setValue(e.target.value)}
                />
                <Button onClick={() => onChange(value)} className="bg-black text-white hover:bg-black/80">
                    Apply
                </Button>
            </DropdownMenuContent>
        </DropdownMenu>
...
const HighlightColorButton = () => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="border-0 p-0 bg-white">
                <SketchPicker
                    color={value}
                    onChange={onChange}
                />
